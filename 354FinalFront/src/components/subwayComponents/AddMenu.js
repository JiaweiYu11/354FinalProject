...
function AddMenu() {
    const api = 'http://localhost:3000/subway'
    ...
    <div className="container">
            <div className="col-md-6 mb-4">
                ...
                <form onSubmit={(e)=> submit(e)}>
                    ...
                    <div className="mb-3">
                        <label htmlFor="subwayTitle" className="form-label">Dish Name</label>
                        <input className="form-control" id="dishName" value={mc.dishName} onChange={(e) => handle(e)}></input>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="subwayTitle" className="form-label">Enter the Price</label>
